...
function TermsAndCond(props) {
  console.log(props);

  const handleAccept = () => {
    props.setConditionAccepted(false);
    sessionStorage.setItem("buttonShow", true);
  }
  console.log(props.conditionAccepted);
  return (
    <div className="terms-and-cond-page">
      ...
      <p>Welcome to Global Vistar!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Symble Solutions Pvt Ltd's Website, located at www.globalvistar.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Global Vistar if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Global Vistar, you agreed to
        use cookies in agreement with the Symble Solutions Pvt Ltd's Privacy
        Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Symble Solutions Pvt Ltd and/or its licensors
        own the intellectual property rights for all material on Global Vistar.
        All intellectual property rights are reserved. You may access this from
        Global Vistar for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Global Vistar</li>
        <li>Sell, rent or sub-license material from Global Vistar</li>
        <li>Reproduce, duplicate or copy material from Global Vistar</li>
        <li>Redistribute content from Global Vistar</li>
      </ul>
      ...
      <p>
        ...
        Symble Solutions Pvt Ltd does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of Symble Solutions Pvt Ltd,its agents and/or
        ...
        laws, Symble Solutions Pvt Ltd shall not be liable for the Comments or
      ...
      <p>
        Symble Solutions Pvt Ltd reserves the right to monitor all Comments and
      ...
      <p>
        You hereby grant Symble Solutions Pvt Ltd a non-exclusive license to
      ...
      <p>
        ...
        the hyperlink compensates the absence of Symble Solutions Pvt Ltd; and
      ...
      <p>
        ...
        e-mail to Symble Solutions Pvt Ltd. Please include your name, your
      ...
      <p>
        No use of Symble Solutions Pvt Ltd's logo or other artwork will be
      ...
      <div>
        <label htmlFor="">
          ...
          Accept this terms and conditions to register as a distributor or a manufacturer.
        </label>
      </div>
